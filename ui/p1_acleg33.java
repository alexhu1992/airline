...
import com.airline.db.DBDriver;
	...
	public class p1_acleg33 extends sys_ui {
		...
		public static String GetLeg3() {
			...
			try { 	 
				String sql1="SELECT c.* FROM flight as a left outer join flight as b on a.arrival_airport_code=b.departure_airport_code left outer join flight as c on b.arrival_airport_code=c.departure_airport_code where a.weekdays=b.weekdays and b.weekdays=c.weekdays and a.departure_airport_code ='" +jp1_jtf1.getText()+"'and c.arrival_airport_code='" +jp1_jtf2.getText()+"'"+"and timediff(c.scheduled_departure_time,b.scheduled_arrival_time)>1;";
