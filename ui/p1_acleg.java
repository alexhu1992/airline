...
public class p1_acleg extends sys_ui{
	...
	public static String GetLeg() {
		...
		try { 	 
			   String sql="SELECT a.* FROM flight as a left outer join flight as b on a.arrival_airport_code=b.departure_airport_code where a.weekdays=b.weekdays and a.departure_airport_code ='" +jp1_jtf1.getText()+"'and b.arrival_airport_code='" +jp1_jtf2.getText()+"'"+"and timediff(b.scheduled_departure_time,a.scheduled_arrival_time)>1;";
